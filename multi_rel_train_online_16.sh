...
# start training
python -u bin/train.py -cn big-lama-geomap data.batch_size=16 +trainer.kwargs.resume_from_checkpoint=/mnt/tqnas/zhijiang/home/yuansy/lama/big-lama-finetune/big-lama-with-discr-remove-loss_segm_pl.ckpt
